...
public class Tablero extends JFrame {
    ...
    private void indexElements(){
        this.indexApples(Integer.parseInt(JOptionPane.showInputDialog(
            "Con cuantas manzanas desea jugar: (3) (5) (7)")), this.indexHourses());
    }

    private Map<String, Integer> indexHourses() {
        Map <String, Integer> map = new HashMap<>();
        map.put("filaCB", aleatoreo.nextInt(6));
        map.put("columnaCB", aleatoreo.nextInt(6));
        map.put("filaCN", aleatoreo.nextInt(6));
    ...
    private void indexApples(int respuesta, Map<String, Integer> positions){
        if (respuesta <= 1) {
            respuesta = 1;
        }
